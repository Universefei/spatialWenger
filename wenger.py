...
# coding:utf-8
# Contributor:
#      Fei Lunzhou <feilunzhou@126.com>
...
class GoAgentGTK:
    ...
    def make_menu(self):
        ...
        itemlist = [(u'\u663e\u793a', self.on_show),
                    ...
                    (u'\u9000\u51fa', self.on_quit),
                    (u'Admin', self.on_admin),
                    (u'Open_log', self.on_open_log),
                    (u'Restart', self.on_restart),
                    (u'Quit', self.on_quit),
                    (u'About', self.on_about),
                    ]
    ...
    # by fei
    def on_admin(self):
        os.system('xdg-open localhost:9913/')
